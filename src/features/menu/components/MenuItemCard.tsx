  ...
  return (
    <motion.div
      ...
      className={`group bg-white rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl overflow-hidden transition-all relative ${
        isBestSeller ? "ring-2 ring-yellow-400 ring-offset-2" : "border border-gray-200"
      }`}
    >
      {/* Best Seller Badge */}
      ...
      {/* Image with Overlay */}
      <div className="relative h-40 sm:h-48 lg:h-56 bg-gradient-to-br from-green-50 to-emerald-50 overflow-hidden">
        <Image
          src={item.fotoUrl}
          alt={item.namaBarang}
          fill
      ...
      <div className="p-4 sm:p-5 space-y-3">
        <h3 className="text-base sm:text-lg font-bold text-gray-900 line-clamp-1 group-hover:text-green-600 transition-colors">
          {item.namaBarang}
        </h3>
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-xs sm:text-sm text-gray-600 bg-gradient-to-br from-gray-100 to-gray-200 px-3 py-1.5 rounded-full font-semibold">
        ...
        <motion.button
          ...
          className={`w-full py-3 sm:py-3.5 px-4 rounded-xl sm:rounded-2xl transition-all font-bold text-sm sm:text-base flex items-center justify-center gap-2 shadow-lg ${
